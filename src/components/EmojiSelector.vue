...
<v-container class="px-auto py-0">
    ...
    <v-row>
        ...
        <v-col cols="12" sm="9" ref="emojiset" style="max-height:350px; overflow-y:auto">
            <v-btn class="e-size32px" @click="baseEmoji=emoji" v-for="emoji in emojis" :key="emoji.codepoint">
                <emoji class="pt-1" raw="true" :emoji="emoji.codepoint"/>
            </v-btn>
        </v-col>
    </v-row>
...
export default class EmojiSelector extends Vue {
    ...
    get currentEmoji() { return this.baseEmoji.codepoint; }
    baseEmoji:Emoji = new Emoji("1F43A");
    currentColor = "#00FF00";
    emojis = [
        new Emoji("1F476"), new Emoji("1F648"), new Emoji("1F649"), new Emoji("1F64A"), new Emoji("1F9A7"), new Emoji("1F98D"), new Emoji("1F435"), new Emoji("1F436"),
        ...
        new Emoji("1F35E"), new Emoji("1F950"), new Emoji("1F968"), new Emoji("1F95E"), new Emoji("1F9C7"), new Emoji("1F9C0"), new Emoji("1F96A"), new Emoji("1F32E"), 
        new Emoji("1FAD4"), new Emoji("1F959"), new Emoji("1F372"), new Emoji("1F957"), new Emoji("1F37F"), new Emoji("1F371"), new Emoji("1F359"), new Emoji("1F35A"),
        new Emoji("1F35B"), new Emoji("1F363"), new Emoji("1F95F"), new Emoji("1F960"), new Emoji("1F9C1"), new Emoji("1F967"), new Emoji("1F36F"), new Emoji("1F9CB")
    ];
